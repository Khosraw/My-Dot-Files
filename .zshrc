...
# Set personal alpython -c "import ssl; print(ssl.get_default_verify_paths())"iases, overriding those provided by oh-my-zsh libs,
...
export PATH="$PATH:/root/.local/bin" && export PATH="$PATH:/home/khosraw/.local/bin" && export SPOTIPY_CLIENT_ID=[client_id] && export SPOTIPY_CLIENT_SECRET=[secret_key] && export QT_QPA_PLATFORMTHEME=qt5ct
...
# |____/ |_|
# DT's ZSH Config merged/modified. Not much to see here; just some pretty standard stuff.
...
xdo raise -N Polybar
# command hideIt.sh --name '^bspwm$' --region 612x0+688+10 --direction top --interval 0.1
### "vim" as manpager
...
alias spotiplay='spotify -l https://open.spotify.com/playlist/0WxnlSSVjvrzF2AVGxvkoc?si=bc90f0bde9294a77 -o ~/Music/songs'
